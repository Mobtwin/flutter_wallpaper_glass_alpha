...
class _FullScreenState extends State<FullScreen> {
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: appIcon(IconsConstants.share, false,
                                      context, 26, 26),
                                ),
                              ),
                            ),
                            InkWell(
                              onTap: () async {
                                    ...
                                    builder: (context) {
                                      return Center(
                                        child: CircularProgressIndicator(
                                          color: Color(hexToColor(dataprovider
                                                  .data.mainColor
                                                  .toString())
                                              .value),
                                        ),
                                ...
                                await saveImage(widget.image, context)
                                    .whenComplete(() {
                                  Navigator.pop(context);
                                });
                              },
                              child: Container(
                                ...
                                child: Center(
                                  child: appIcon(IconsConstants.download, false,
                                      context, 26, 26),
                                ),
                              ),
                            ),
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: appIcon(IconsConstants.setas, false,
                                      context, 26, 26),
                                ),
                              ),
                            ),
  ...
  static const platform =
      MethodChannel('com.example.my_wallpaper/setWallpaper');
